										...
										if(isset($_POST["submit"]))
											{
												...
												if ($id ==""||$user ==""||$password == ""|| $roleID == ""||  $aName == "" || $aAge == "") 
													{
														echo "Please fill the blank!";
													}
												else
													{
														$sql = "UPDATE account SET accountID='$id',username='$user',password='$password',roleID='$roleID',aName='$aName', aAge='$aAge' WHERE accountID=" . $id;
